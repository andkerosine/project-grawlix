...
static Maze init_maze(int width, int height, char state);
static void carve_maze(Maze*, algorithm, int bias);
static void reset_maze(Maze*, char state);
static void display_maze(Maze*);
static void destroy_maze(Maze*);
